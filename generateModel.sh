...
npx sequelize-cli model:generate --name bankaccounts --attributes id:uuid,accountIsd:uuid,accNo:string,ifsc:string,micr:string,accountHolderName:string,branch:string
